    ...
    <div class="toplinks">
			...
			<?php
			 ...
			 <ul class="loginlinks">
          	 ...
          	 <?php } else { ?> 
			 <ul class="loginlinks">
            	<li><a href="<?php print $base_url; ?>/user/login" onclick="addCustomText();" rel="lightmodal">Wellness Affiliate Login</a></li>
                <li>|</li>
                <li><a href="<?php print $base_url; ?>/user/login" onclick="removeText();" rel="lightmodal">Customer Login</a></li>
             </ul>
			<?php } ?>
...
<script type="text/javascript">
	function addCustomText() {
		...
		div.innerHTML = "";
		div.innerHTML = div.innerHTML + 'Wellness Affiliate Login | Welcome Back!';
	}
	function removeText() {
		var div = document.getElementById('frameHoverNav');
		div.innerHTML = "";
