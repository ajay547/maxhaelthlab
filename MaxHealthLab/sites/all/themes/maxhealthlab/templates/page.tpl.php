...
<body class="<?php print $classes; ?>">
  ...
  <div id="page-wrapper"><div id="page">
    <div class="toplinks">
        	<div class="checkout"><a href="<?php print $base_url; ?>/cart">My Cart</a> | <a href="#">Checkout</a></div>
			<div class="search_sect">
			 <?php if ($search_box): ?>
             <div id="search-box" class="search_bg">
		     <?php print $search_box; ?>
		     </div>
             <?php endif; ?>
             </div><!--search sect end here-->
			 <?php 
			  if($user->uid) { 
		     ?> 
			 <ul class="loginlinks">
            	<li><a href="<?php print $base_url; ?>/user/<?php print $user->uid; ?>">View My Account</a></li>
                <li>|</li>
				<li><a href="<?php print $base_url; ?>/user/<?php print $user->uid; ?>/edit">Edit My Account</a></li>
				<li>|</li>
			 ...
			 <ul class="loginlinks">
            	<li>
				<a href="<?php print $base_url; ?>/user/login?type=wellness" onclick="addCustomText();" rel="lightmodal">Wellness Affiliate Login</a>
				</li>
                <li>|</li>
                <li><a href="<?php print $base_url; ?>/user/login" rel="lightmodal">Customer Login</a></li>
             </ul>
			<?php } ?>
        </div><!--top links end here-->
	...
	<?php if($main_wrapper_bottom) : ?>
     <div id="bottom_content">
	  <?php print $main_wrapper_bottom; ?>
	 </div>
    <?php endif; ?>
    ...
    <?php if ($footer || $footer_message || $secondary_links): ?>
      <div id="footer"><div class="section">
		...
		<script type="text/javascript">
			...
			var _gaq = _gaq || [];
			_gaq.push(['_setAccount', 'UA-33055227-1']);
...
<script type="text/javascript">
	function addCustomText() {
		...
		alert(vars);
		document.getElementById("frameHoverNav").innerHTML = "";
		var div = document.getElementById('frameHoverNav');
		div.innerHTML = div.innerHTML + '<div id="well-text">Wellness Affiliate Login | Welcome Back!</div>';
	}
</script>
</body>
</html>
